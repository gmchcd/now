...
import {encrypt} from "./utils/encdec.mjs";
...
async function login(params={}){
    ...
    var encKey = (answer + params.status + "AAAAAAAAAAAAAAAA").substring(0, 16);
    var loginData = encrypt(encKey, (params.userID + "#UP#" + Buffer.from(params.password, 'utf8').toString('base64') + "#UP#" + (new Date).getTime()))
